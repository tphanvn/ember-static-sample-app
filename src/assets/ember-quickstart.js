...
;
          if (!runningTests) {
            require("ember-quickstart/app")["default"].create({"LOG_ACTIVE_GENERATION":false,"LOG_VIEW_LOOKUPS":false,"autoboot":false,"name":"ember-quickstart","version":"0.0.0+01f436bc"});
          }
